...
export const VerifyEmailScreen: React.FC<ScreenProps> = ({ navigate, data }) => {
    const handleVerify = () => {
         ...
         <div className="pt-4">
          ...
          <div className="mt-8 space-y-8">
               <div className="space-y-2">
                  <h2 className="text-[24px] font-semibold text-[#444444]">Vérification</h2>
                  <p className="text-[#666666]">Entrez le code envoyé à votre adresse email</p>
               </div>
